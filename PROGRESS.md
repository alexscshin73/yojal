...
**현재 게이트**: 기획 단계
**게이트 상태**: ⏳ 미완성 — 화면 목록 논의 중
**다음 할 일**: 화면 목록 논의 완료 → PLANNING.md 승인 → 설계 단계 시작

---

## 게이트 현황

- [ ] **기획 게이트**: PLANNING.md 완성 + 승인 ← **지금 여기**
  - [x] 서비스 정의
  - [x] 핵심 컨셉
  - [x] AI 전략
  - [x] 기술 스택
  ...
  - [ ] 화면 목록 (논의 중)
  - [x] MVP 범위
- [ ] **설계 게이트**: 화면 설계 문서 완성 + 승인
- [ ] **개발 게이트**: 기능별 완료 기준 명시 + 승인
