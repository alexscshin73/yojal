...
| ID | 태스크 | 의존 | 상태 |
|----|--------|------|------|
| P2-01 | SQLite DB 스키마 | — | ⏳ 대기 |
| P2-02 | Learning Item 시드 데이터 | P2-01 | ⏳ 대기 |
...
### 시드 데이터 구성 (1차: CAPÍTULO 1 기준)

| 타입 | 수량 | 예시 |
|------|------|------|
| 인사 표현 | 10개 | Hola, Buenos días, ¿Qué tal? |
| 인칭대명사 | 9개 | yo, tú, él, ella... |
| ser 동사 활용 | 6개 | soy, eres, es, somos, sois, son |
| 발음 규칙 문법 | 5개 | h 묵음, ñ, que/qui... |
| 예문 | 5개 | Yo soy estudiante. |
